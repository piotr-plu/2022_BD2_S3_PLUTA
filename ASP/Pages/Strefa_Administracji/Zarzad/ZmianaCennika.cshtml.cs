...
namespace Narciarze_v_2.Pages.Strefa_Administracji.Zarzad
{
    public class ZmianaCennikaModel : PageModel
    {
        ...
        public void OnPostCennik_n()
        {
            ...
            ee1.id = Request.Form["wyciag"].ToString();
            //string query8 = "SELECT min(Data_zak) as mini, w.Nazwa as nazwa FROM Cennik as c, Wyciagi as w, Cena_bilety as cb WHERE c.ID_Cena_bilet = cb.ID AND w.ID = cb.ID_Wyciag AND w.ID = '" + ee1.id+ "' GROUP BY w.Nazwa";
            ...
            //            ee1.gr = reader["mini"].ToString();
            //            var date1 = DateTime.Parse(ee1.gr);
            //            ee1.gr = date1.Year.ToString() + "-" + date1.Month.ToString() + "-" + date1.Day.ToString();
            //            ee.Add(ee1);
            //        }
            //    }
            //}
        ...
        public void OnPostDodaj()
        {
            ...
            e4.nazwa = Request.Form["nazw"].ToString();
