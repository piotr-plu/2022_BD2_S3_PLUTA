...
namespace Narciarze_v_2.Pages.Strefa_Administracji.Kasa
{
    public class SprzedarzModel : PageModel
    {
        ...
        public void OnGet() //Wyœwietlanie list rozwijanych
        {
            /*=========================DO POPRAWY TA CZÊŒÆ=======================================*/
            ...
            conn.Open();
            string query1 = "SELECT Imie as imie, Nazwisko as nazw, ID as id FROM Klient";
            ...
            /*=========================DO POPRAWY TA CZÊŒÆ=======================================*/
            string query2 = "SELECT ID as id, Nazwa as nazwa FROM Wyciagi";
            using (SqlCommand command = new SqlCommand(query2, conn))
            {
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        w1.nazwa = reader["nazwa"].ToString();
                        w.Add(w1);
                    }
                }
            }
        ...
        public void OnPostBilet() //Zakup nowego biletu
        {
            SqlConnection conn = new SqlConnection("Data Source=DESKTOP-L54I9S2\\NARCIARZE;Initial Catalog=narty;Integrated Security=True");
            conn.Open();
            Klient k2 = new Klient();
            k2.id = Request.Form["klient"].ToString();
            Wyciag w2 = new Wyciag();
            Cennik c1 = new Cennik();
            w2.id = Request.Form["wyciag"].ToString();
            w2.ilosc_zjazdow = Request.Form["ilosc"].ToString();
            ...
            Response.Redirect("/Strefa_Administracji/Kasa/Sprzedarz");
        }

            public void OnPostRejestracja() //Rejestracja nowego urzytkownika
            {
